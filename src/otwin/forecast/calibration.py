...
interval metrics in :mod:`otwin.forecast.metrics` rather than reimplementing them.
...
from otwin.forecast.metrics import mpiw, picp
...
def sharpness(
    ...
    """Mean prediction interval width (alias of :func:`otwin.forecast.metrics.mpiw`)."""
